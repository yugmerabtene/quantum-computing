# Séance 12.1 — Qubits supraconducteurs
...
où $\delta$ est la différence de phase supraconductrice et $I_c$ le courant critique.
...
où $\hat{n}$ est le nombre de paires de Cooper et $\hat{\delta}$ la phase.
...
où $p$ est le taux d'erreur physique et $p_{\text{th}} \approx 1\%$ le seuil.
