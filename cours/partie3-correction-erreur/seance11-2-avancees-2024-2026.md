# Séance 11.2 — Avancées récentes en correction d'erreur quantique (2024–2026)
...
Processeur logique Harvard (48 qubits, d=3)
  ...
  Succès avec FT : 0.995122

Comparaison avec/sans correction :
    1 cycles : FT=0.9520, Raw=6.1e-01
   10 cycles : FT=0.6138, Raw=7.2e-03
  100 cycles : FT=0.0069, Raw=0.0e+00
 1000 cycles : FT=0.0000, Raw=0.0e+00
```
