...
```
 ...
 •────────────•  |ψ⊥⟩
    ...
    Après k itérations :
    angle = (2k+1)θ → tend vers π/2
    → état proche de |x*⟩
    → mesure donne x* avec P ≈ 1
```
...
```
=== Preuve d'optimalité de Grover ===
N = 1024, √N = 32.0

Classique (moyenne) : 512 requêtes
Grover (optimal)    : 25.1 requêtes
Rapport            : 20×

Borne inférieure    : k ≥ 0.5·√N ≈ 16.0
Grover atteint     : 25.1 ≈ 0.7854·√N
Ratio optimal      : 1.57 (optimal à constante près)
```
